...
ALTER TABLE bills ALTER COLUMN payment_method TYPE VARCHAR(255);
...
ALTER TABLE bills ADD COLUMN IF NOT EXISTS split_cash DECIMAL(10, 2) DEFAULT 0.00;
ALTER TABLE bills ADD COLUMN IF NOT EXISTS split_upi DECIMAL(10, 2) DEFAULT 0.00;
